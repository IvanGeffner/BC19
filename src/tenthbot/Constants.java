...
public class Constants {
    ...
    final static int MAX_TURNS_REPORTING = 3;
    ...
    final static int MEGA_RICH_KARBO = 650;
    final static int MEGA_RICH_FUEL = 3200;
    ...
    final static int MAX_DIST_TROOPS = 25;
    ...
    final static int DIFF_MELEES = 3;
    final static int DIFF_RANGERS = 2;
    final static int SAFETY_FUEL_RANGER = 600;

    final static int SHIFT = 6;
    final static int BASE = 63;
    final static int MAX_DISTANCE_PROPHET = 5;

    final static int MAX_DISTANCE_CLOSE = 16;
