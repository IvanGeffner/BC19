...
public class Attacker {
    ...
    Location tryAttack(){
        ...
        if (bestRobot != null){
            if (myRobot.me.unit == Constants.PROPHET && bestRobot.unit != Constants.PROPHET && bestRobot.unit != Constants.PILGRIM && myRobot.fuel < Constants.SAFETY_FUEL_RANGER) return null;
