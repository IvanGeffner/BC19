...
(function (bc19) {
    var CastleUtils = (function () {
        ...
        CastleUtils.prototype.checkDefense = function () {
            var dir = this.defenseMechanism.defenseAction();
            if (dir != null) {
                var loc = this.getBestProphetLoc(dir);
                if (loc == null)
                    return;
                this.nextTurnAction = this.myRobot.buildUnit(bc19.Constants.PROPHET, bc19.Constants.X_$LI$()[dir], bc19.Constants.Y_$LI$()[dir]);
                this.broadcast.sendTarget(loc, this.broadcast.PROPHET_AGGRO, bc19.Constants.Steplength_$LI$()[dir]);
            }
        };
        ...
        CastleUtils.prototype.checkFreeBuild = function () {
            if (this.nextTurnAction != null)
                return;
            var dir = this.defenseMechanism.buildUnitRich();
            if (dir != null) {
                var loc = this.getBestProphetLoc(dir);
                if (loc == null)
                    return;
        ...
        CastleUtils.prototype.getBestProphetLoc = function (dir) {
            ...
            var myX = this.myRobot.me.x + bc19.Constants.X_$LI$()[dir];
            var myY = this.myRobot.me.y + bc19.Constants.Y_$LI$()[dir];
            distM[myX][myY] = 1;
            var queue = ([]);
            ...
            while ((!(queue.length == 0))) {
                ...
                if ((last.x + last.y) % 2 === bc19.Constants.MOD2 && !this.myRobot.karboniteMap[last.y][last.x] && !this.myRobot.fuelMap[last.y][last.x]) {
...
(function (bc19) {
    ...
    Constants.MAX_KARBO_PILGRIM_POOR = 10;
    Constants.POOR_KARBO = 110;
...
(function (bc19) {
    var FinalAttack = (function () {
        ...
        FinalAttack.prototype.mySymmetric = function () {
            return this.symmetry.getSymmetric(this.castleUtils.myLocation);
        };
        return FinalAttack;
    }());
...
(function (bc19) {
    var Symmetry = (function () {
        ...
        Symmetry.prototype.getSymmetric = function (loc) {
            if (this.xSym) {
...
(function (bc19) {
    var Church = (function (_super) {
        ...
        Church.prototype.getAction = function () {
            var dir = this.defenseMechanism.defenseAction();
            if (dir == null)
                dir = this.defenseMechanism.buildUnitRich();
            if (dir != null) {
                var loc = this.getBestProphetLoc(dir);
                if (loc != null) {
                    this.broadcast.sendTarget(loc, this.broadcast.PROPHET_AGGRO, bc19.Constants.Steplength_$LI$()[dir]);
                }
                return this.myRobot.buildUnit(bc19.Constants.PROPHET, bc19.Constants.X_$LI$()[dir], bc19.Constants.Y_$LI$()[dir]);
            }
            return null;
        };
        Church.prototype.getBestProphetLoc = function (dir) {
            ...
            while ((!(queue.length == 0))) {
                ...
                var lastFuel = fuel[last.x][last.y];
                var lastDist = distM[last.x][last.y];
                if ((last.x + last.y) % 2 === bc19.Constants.MOD2 && !this.myRobot.karboniteMap[last.y][last.x] && !this.myRobot.fuelMap[last.y][last.x] && this.utils.robotMap[last.y][last.x] === 0) {
                    return last;
                }
                for (var i = 0; i < bc19.Constants.rad4Index; ++i) {
                    var newX = last.x + bc19.Constants.X_$LI$()[i];
