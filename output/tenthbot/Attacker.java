...
public class Attacker {
    ...
    Location tryAttack(){
        ...
        if (bestRobot != null){
            if (myRobot.me.unit == Constants.PROPHET && (bestRobot.unit == Constants.CRUSADER || bestRobot.unit == Constants.PREACHER) && myRobot.fuel < Constants.SAFETY_FUEL_RANGER) return null;
    ...
    class PreacherLoc{
        ...
        boolean isBetterThan(PreacherLoc loc){
            ...
            return value()*100 + utils.distance(myRobot.me.x, myRobot.me.y, x, y)  >= loc.value()*100 + utils.distance(myRobot.me.x, myRobot.me.y, loc.x, loc.y);
        }
    }
