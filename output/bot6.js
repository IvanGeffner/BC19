...
(function (bc19) {
    var CastleUtils = (function () {
        function CastleUtils(myRobot) {
            ...
            this.attack = new bc19.Attacker(myRobot, this.utils);
...
(function (bc19) {
    var Attacker = (function () {
        function Attacker(myRobot, utils) {
            this.myRobot = null;
            this.utils = null;
            this.myRobot = myRobot;
            this.utils = utils;
        ...
        Attacker.prototype.inRange = function (r) {
...
(function (bc19) {
    var Micro = (function () {
        ...
        Micro.prototype.getBestIndex = function () {
            ...
            this.bestMicro = null;
            for (var index129 = 0; index129 < this.microInfoArray.length; index129++) {
                var m = this.microInfoArray[index129];
                {
            ...
            for (var index130 = 0; index130 < this.utils.robotsInVision.length; index130++) {
                var r = this.utils.robotsInVision[index130];
                {
                    if (this.myRobot.isVisible(r) && r.team !== this.myRobot.me.team) {
                        for (var index131 = 0; index131 < this.microInfoArray.length; index131++) {
                            var m = this.microInfoArray[index131];
                            {
                                if (m.accessible)
                                    m.update(r);
                            }
...
(function (bc19) {
    var Pilgrim = (function (_super) {
        ...
        Pilgrim.prototype.findClosestStructure = function () {
            ...
            this.checkStructure();
            for (var index132 = 0; index132 < this.utils.robotsInVision.length; index132++) {
                var r = this.utils.robotsInVision[index132];
                {
                    if (r.team !== this.myRobot.me.team)
                        continue;
...
(function (bc19) {
    var Prophet = (function (_super) {
        ...
        function Prophet(myRobot) {
            ...
            _this.broadcast = new bc19.Broadcast(myRobot, _this.utils);
            _this.attack = new bc19.Attacker(myRobot, _this.utils);
        ...
        Prophet.prototype.chooseAction = function () {
            ...
            var attackAction = this.attack.tryAttack();
            if (attackAction != null)
                return attackAction;
            if (microAction != null && microAction !== this.micro.maxMovementIndex)
                return this.myRobot.move(bc19.Constants.X_$LI$()[microAction], bc19.Constants.Y_$LI$()[microAction]);
