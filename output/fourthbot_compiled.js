...
(function (bc19) {
    var Utils = (function () {
        ...
        Utils.prototype.distance$bc19_Location$bc19_Location = function (loc1, loc2) {
            return this.distance$int$int$int$int(loc1.x, loc2.x, loc1.y, loc2.y);
        };
        return Utils;
    }());
    bc19.Utils = Utils;
...
(function (bc19) {
    var CastleUtils = (function () {
        ...
        CastleUtils.prototype.shouldBuildPilgrim = function () {
            var totalCostKarbo = this.churchRequiredCont * bc19.Constants.karboCosts_$LI$()[bc19.Constants.CHURCH];
    ...
    var ChurchBuild = (function () {
        ...
        ChurchBuild.prototype.tryBuildChurch = function () {
            ...
            if (!this.pilgrim.needChurch())
                return;
            if (!this.utils.canBuild(bc19.Constants.CHURCH))
                return;
            this.maxValue = 0;
...
(function (bc19) {
    var CastleCommunication = (function () {
        ...
        CastleCommunication.prototype.readRound = function () {
            ...
            for (var index123 = 0; index123 < visibleRobots.length; index123++) {
                var r = visibleRobots[index123];
                {
    ...
    var Pilgrim = (function (_super) {
        ...
        Pilgrim.prototype.goToDestination = function () {
            ...
            if (this.targetCode === this.MINING_TARGET) {
                ...
                if (this.utils.distance$int$int$int$int(myX, this.destination.x, myY, this.destination.y) <= 2) {
